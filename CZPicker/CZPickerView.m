...
#define CZP_BACKGROUND_ALPHA 1.0
#else
...
- (id)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
        ...
        self.headerBackgroundColor = [UIColor colorWithRed:0.98 green:0.39 blue:0.37 alpha:1.0];
        
        //UIColor(red:0.98, green:0.39, blue:0.37, alpha:1.0)
...
- (UIView *)buildHeaderView{
    ...
    UIFont *headerFont = self.headerTitleFont == nil ? [UIFont fontWithName:@"AvenirNext-Bold" size:16.5] : self.headerTitleFont;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if([self.dataSource respondsToSelector:@selector(czpickerView:titleForRow:)] && [self.dataSource respondsToSelector:@selector(czpickerView:imageForRow:)]){
        ...
        cell.textLabel.font = [UIFont fontWithName:@"AvenirNext-Bold" size:16];
